...
function on_webapp_change() {
    ...
    if (window) {
        ...
        c.set('IPport', webapp.opts.IPport)
...
function create_polymer_elements() {
    ...
    Polymer({
        ...
        properties: {
            ...
            IPport: { type: Text, value: "192.168.1.1" },
            state: { type: String,
    ...
    Polymer({
        ...
        onIpPortChange: function () {
            var IPport = this.IPport
            console.log('persist IPport', IPport)
            webapp.opts.IPport = IPport
            webapp.IPport = IPport
            appOptions.set('IPport', IPport)
        },
